 ...
 * This is the PSR-4 standard example autoloader, with getInstance() added to make calling it from other modules easier.
 * @link https://github.com/php-fig/fig-standards/blob/master/accepted/PSR-4-autoloader-examples.md#class-example
 */
class Autoloader
{
    /**
     * @var Autoloader|null Autoloader instance
     */
